...
export default function OfficerRegister() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', department: '', idCard: null });
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      setForm({ name: '', email: '', password: '', department: '', idCard: null });
      event.target.reset();
    } catch (requestError) {
