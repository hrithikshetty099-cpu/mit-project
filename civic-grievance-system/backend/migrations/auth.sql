...
ALTER TABLE complaints ADD COLUMN IF NOT EXISTS contact_phone TEXT;
...
ALTER TABLE complaints ADD COLUMN IF NOT EXISTS deadline_at TIMESTAMPTZ;
ALTER TABLE complaints ADD COLUMN IF NOT EXISTS reminder_at TIMESTAMPTZ;
